            ...
            <TabPanels>
              ...
              <TabPanel value="usage">
                ...
                <RenderVariations
                  ...
                  text={TEXT_1}
                />
                {!laptop && renderSideBarItem([NAVIGATIONBAR.usage.installation.label, NAVIGATIONBAR.usage.group.label], selectedVariationSideBarItem, variationRefs)}
              </TabPanel>
              <TabPanel value="props">
                ...
                />
                {!laptop && renderSideBarItem([NAVIGATIONBAR.props.children.name, NAVIGATIONBAR.props.color.name], selectedPropsSideBarItem, propsRef)}
              </TabPanel>
            </TabPanels>
          </Tabs>
        </div>
