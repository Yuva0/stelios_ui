  ...
  return (
    <div>
      <div style={{ margin: "1.5rem 0 4rem 0", width: "calc(100% - 10rem)" }}>
        <RenderBreadcrumbsForComponent name={BUTTONTEXT.title}/>
        <div style={{ padding: "1rem" }}>

          <RenderComponentHeading title={BUTTONTEXT.title} description={BUTTONTEXT.description}/>
          ...
          <Tabs color="primary" style={{ marginTop: "2rem" }} value="usage">
            ...
            <TabPanels>
              ...
              <TabPanel value="usage">
                {/* Usage Variations */}
                <RenderVariations label={BUTTONTEXT.usage.installation.label} text={BUTTONTEXT.usage.installation.description}/>
                <RenderVariations label={BUTTONTEXT.usage.variants.label} description={BUTTONTEXT.usage.variants.description} code={CODE_1} text={TEXT_1}/>
                <RenderVariations label={BUTTONTEXT.usage.sizes.label} description={BUTTONTEXT.usage.sizes.description} code={CODE_2} text={TEXT_2}/>
                <RenderVariations label={BUTTONTEXT.usage.icons.label} description={BUTTONTEXT.usage.icons.description} code={CODE_3} text={TEXT_3}/>
                <RenderVariations label={BUTTONTEXT.usage.rounded.label} description={BUTTONTEXT.usage.rounded.description} code={CODE_4} text={TEXT_4}/>
                <RenderVariations label={BUTTONTEXT.usage.disabled.label} description={BUTTONTEXT.usage.disabled.description} code={CODE_5} text={TEXT_5}/>
                <RenderVariations label={BUTTONTEXT.usage.fullWidth.label} description={BUTTONTEXT.usage.fullWidth.description} code={CODE_6} text={TEXT_6}/>
